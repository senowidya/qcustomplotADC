...
void serialrxtx::terima_data(){
    ...
    ui->myPlot->addGraph();
    ui->myPlot->graph()->setData(datax,datay1);
    ui->myPlot->graph()->setPen(QPen(Qt::red));

    ui->myPlot->addGraph();
    ui->myPlot->graph()->setData(datax,datay2);
    ui->myPlot->graph()->setPen(QPen(Qt::yellow));

    ui->myPlot->addGraph();
    ui->myPlot->graph()->setData(datax,datay3);
    ui->myPlot->graph()->setPen(QPen(Qt::black));
